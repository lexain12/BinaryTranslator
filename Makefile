...
all: main.cpp ./language/Analyzer/WriteIntoDb.cpp
	$(CXX) $(CXXFLAGS) main.cpp ./language/Analyzer/WriteIntoDb.cpp ./language/Analyzer/utils.cpp ./language/utils/src/ErrorHandlerLib.cpp ./language/utils/src/consoleColorLib.cpp ./language/Analyzer/tokenizer.cpp ./BinaryTranslator.cpp ./language/readerLib/functions.cpp ./language/logs/LogLib.cpp -o binTranslate
